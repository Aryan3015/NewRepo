...
// Add this right under your app.use(session({...})) block
...
// Create post
// Create post (Now saves the user_id)
...
app.patch("/posts/:id", isLoggedIn, (req, res) => {
    ...
    // We verify ownership again before updating
